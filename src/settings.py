...
ENABLE_DERIVATIVES = _bool(os.getenv("SETTLE_ENABLE_DERIVATIVES", "true"))
ENABLE_MARGINS = _bool(os.getenv("SETTLE_ENABLE_MARGINS", "true"))
ENABLE_DEBT = _bool(os.getenv("SETTLE_ENABLE_DEBT", "true"))
ENABLE_ADVANCED_FEATURES = _bool(os.getenv("SETTLE_ENABLE_ADVANCED", "true"))
